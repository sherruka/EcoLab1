 ...
 *
 * <описание>
 *   Обработчик события обмена элементов сортировки с учётом шага
 * </описание>
 *
 */
int16_t ECOCALLMETHOD CEcoLab1Sink_OnSortSwap(/* in */ struct IEcoLab1Events* me, /* in */ int16_t indexSrc, /* in */ int16_t indexDst) {
    ...
    pCMe->m_iStep++;
    printf("  [Sink %p] Step %d: SWAP positions %d <-> %d\n", (void*)pCMe, pCMe->m_iStep, indexSrc, indexDst);
 ...
 *
 * <описание>
 *   Обработчик события сравнения элементов сортировки с учётом шага
 * </описание>
 *
 */
int16_t ECOCALLMETHOD CEcoLab1Sink_OnSortCompare(/* in */ struct IEcoLab1Events* me, /* in */ int16_t index1, /* in */ int16_t index2, /* in */ int16_t result) {
    CEcoLab1Sink* pCMe = (CEcoLab1Sink*)me;
    ...
    pCMe->m_iStep++;
    if (result < 0) {
        printf("  [Sink %p] Step %d: COMPARE arr[%d] < arr[%d]\n", (void*)pCMe, pCMe->m_iStep, index1, index2);
    } else if (result > 0) {
        printf("  [Sink %p] Step %d: COMPARE arr[%d] > arr[%d]\n", (void*)pCMe, pCMe->m_iStep, index1, index2);
    } else {
        printf("  [Sink %p] Step %d: COMPARE arr[%d] == arr[%d]\n", (void*)pCMe, pCMe->m_iStep, index1, index2);
 ...
 *
 * <сводка>
 *   Функция OnSortStageStart
 * </сводка>
 *
 * <описание>
 *   Обработчик события начала этапа сортировки
 * </описание>
 *
 */
int16_t ECOCALLMETHOD CEcoLab1Sink_OnSortStageStart(/* in */ struct IEcoLab1Events* me, /* in */ int16_t stage, /* in */ int16_t dir) {
    CEcoLab1Sink* pCMe = (CEcoLab1Sink*)me;
    ...
    printf("  [Sink %p] --- Stage size=%d, direction=%s ---\n", (void*)pCMe, stage, (dir == 1) ? "ASCENDING" : "DESCENDING");

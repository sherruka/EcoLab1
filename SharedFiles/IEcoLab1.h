...
typedef struct IEcoLab1VTbl {
    ...
    /* IEcoLab1 */
    int16_t (ECOCALLMETHOD *CEcoLab1_bitonicSort_int)(/* in */ IEcoLab1Ptr_t me, int *arr, size_t arrSize, int ascending); 
	int16_t (ECOCALLMETHOD *CEcoLab1_bitonicSort_long)(/* in */ IEcoLab1Ptr_t me, long *arr, size_t arrSize, int ascending); 
	int16_t (ECOCALLMETHOD *CEcoLab1_bitonicSort_float)(/* in */ IEcoLab1Ptr_t me, float *arr, size_t arrSize, int ascending); 
	int16_t (ECOCALLMETHOD *CEcoLab1_bitonicSort_double)(/* in */ IEcoLab1Ptr_t me, double *arr, size_t arrSize, int ascending);
	int16_t (ECOCALLMETHOD *CEcoLab1_bitonicSort_longdouble)(/* in */ IEcoLab1Ptr_t me, long double *arr, size_t arrSize, int ascending);

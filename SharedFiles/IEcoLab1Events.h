 ...
 *
 * <описание>
 *   Данный заголовок описывает интерфейс событий IEcoLab1Events
 * </описание>
 *
 * <ссылка>
 *
...
typedef struct IEcoLab1VTblEvents {
    ...
    /* IEcoLab1Events - Bitonic Sort Events */
    int16_t (ECOCALLMETHOD *OnSortSwap)(/* in */ struct IEcoLab1Events* me, /* in */ int16_t indexSrc, /* in */ int16_t indexDst);
    int16_t (ECOCALLMETHOD *OnSortCompare)(/* in */ struct IEcoLab1Events* me, /* in */ int16_t index1, /* in */ int16_t index2, /* in */ int16_t result);
    int16_t (ECOCALLMETHOD *OnSortStageStart)(/* in */ struct IEcoLab1Events* me, /* in */ int16_t stage, /* in */ int16_t dir);
